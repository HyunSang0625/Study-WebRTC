...
<a id="downloadLink" type="video/webm" style="display: none"></a>
    ...
    async _startCapturing(e){
        console.log('Start Display Capturing.');
        ...
        this.medaiRecorder = new MediaRecorder(this.stream, {mimeType: 'video/webm'});
        this.medaiRecorder.addEventListener('dataavailable', event => {
            if (event.data && event.data.size > 0){
                this.chunks.push(ecvent.data);
            }
        });
        this.medaiRecorder.start(10);
    }
